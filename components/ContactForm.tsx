          ...
          <div className="reveal" style={{ transitionDelay: '0.2s' }}>
            <form onSubmit={handleSubmit} className={`p-6 sm:p-10 rounded-[3rem] border shadow-2xl ${
              ...
              <button 
                ...
                type="submit" 
                className={`w-full py-5 rounded-2xl bg-blue-600 text-white font-bold text-lg flex items-center justify-center gap-3 transition-all hover:bg-blue-700 hover:shadow-xl hover:shadow-blue-900/20 active:translate-y-1 disabled:opacity-50 touchable`}
              >
